...
function AddNewSong(): JSX.Element {
    ...
    return (
        <div className="AddNewSong">
            ...
            <input type="text" placeholder="enter song youtube id" onKeyUp={
                (args)=>{
            ...
            <hr/>
            <h3>{songName}</h3><br/>
            <img src={songImageURL} width={320}/><br/>
            {songDesc}<br/><br/><br/>
            {songDesc.length>0 && <input type="button" value="add song" onClick={handleAddSong}/>}
        </div>
    );
}
